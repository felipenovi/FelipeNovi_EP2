...
arquivo=open("entrada_2.txt", encoding="utf-8")
...
#final da criação da lista limpa


forca = turtle.Turtle()  # Cria um objeto "desenhador"
forca.hideturtle
forca.speed(5)  # velocidade do desenho
forca.penup()       
forca.setpos(-250,0)
forca.pendown()
forca.color("yellow")
...
window.exitonclick()
#Observações:
    #caracteres com acento e "espaços" devem ser vistos como se fossem letras diferentes    
